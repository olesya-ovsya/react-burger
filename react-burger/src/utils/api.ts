...
export const getUser = () => {
    ...
    return sendRequest<TResponse<{ user: TUser}>>('auth/user', requestInfo);
}
...
export const postRegister = (model: IUserDataModel) => {
    ...
    return sendRequest<TResponse<{ user: TUser}&TToken>>("auth/register", requestInfo);
}
...
export const postLogin = (model: ILoginModel) => {
    ...
    return sendRequest<TResponse<{user: TUser}&TToken>>("auth/login", requestInfo);
}
