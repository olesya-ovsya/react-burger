...
import { TWSOrdersActions, WS_ORDERS_CONNECTION_CLOSE, WS_ORDERS_CONNECTION_CLOSED, WS_ORDERS_CONNECTION_ERROR, WS_ORDERS_CONNECTION_START, WS_ORDERS_CONNECTION_SUCCESS, WS_ORDERS_GET_DATA, WS_ORDERS_SEND } from '../actions/ws-orders';
import { TWSFeedActions, WS_FEED_CONNECTION_CLOSE, WS_FEED_CONNECTION_CLOSED, WS_FEED_CONNECTION_ERROR, WS_FEED_CONNECTION_START, WS_FEED_CONNECTION_SUCCESS, WS_FEED_GET_DATA, WS_FEED_SEND } from '../actions/ws-feed';
...
export type TWSActions =  {
    ...
    close: typeof WS_FEED_CONNECTION_CLOSE | typeof WS_ORDERS_CONNECTION_CLOSE
};
